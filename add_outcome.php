...
$url = new moodle_url('/mod/checkoutcome/add_outcome.php');
if ($id) {
	...
	print_error('request_too_long', 'checkoutcome'); // 'Possible reason : your selection was too large, try to reduce you selection'
}
...
$PAGE->requires->js('/mod/checkoutcome/checkoutcome.js');

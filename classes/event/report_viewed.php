...
/**
 * The mod_checkoutcome report viewed event class.
 *
 * @package    mod_checkoutcome
 * @since      Moodle 2.7
 * @package    mod_checkoutcome
...
class report_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventreportviewed', 'mod_checkoutcome');
    }
    ...
    public function get_description() {
        ...
        return "The user with id '$this->userid' viewed the report for {$userdesc}the checkoutcome with " .
    ...
    protected function get_legacy_logdata() {
        ...
        return array($this->courseid, 'checkoutcome', 'report', $url, $this->objectid, $this->contextinstanceid);
    }
}

...
/**
 * The mod_checkoutcome student checks updated class.
 *
 * @package    mod_checkoutcome
 * @since      Moodle 2.7
 * borrowed from package checklist 
...
class student_edit_description extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventstudentdescriptionupdated', 'mod_checkoutcome');
    }
    ...
    public function get_description() {
        ...
        "of checkoutcome with the course module id '$this->contextinstanceid'";
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'checkoutcome', 'update description', 'edit_description.php?id='.$this->contextinstanceid, $this->objectid, $this->contextinstanceid);
    }

...
$group  = optional_param('group', 0, PARAM_INT);  // selected group
$selected_periodid  = optional_param('selected_periodid', 0, PARAM_INT);  // selected period


$url = new moodle_url('/mod/checkoutcome/list_gradings.php');
if ($id) {
...
if ($chk = new checkoutcome_class($cm->id, 0, $checkoutcome, $cm, $course, NULL, $group, $selected_periodid)) {
	$chk->list_gradings();
}

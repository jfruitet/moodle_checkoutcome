...
$url = new moodle_url('/mod/checkoutcome/studentdescription.php');
...
$chk = new checkoutcome_class($cm->id, $userid, $checkoutcome, $cm, $course, null, null, $selected_periodid);

$chk->studentdescription();

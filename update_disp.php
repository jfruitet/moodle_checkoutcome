...
$url = new moodle_url('/mod/checkoutcome/update_disp.php');
if ($id) {
...
{
	$PAGE->requires->js('/lib/yui/2.9.0/build/slider/slider-min.js');
	$PAGE->requires->js('/lib/yui/2.9.0/build/utilities/utilities.js');
	$PAGE->requires->js('/lib/yui/2.9.0/build/colorpicker/assets/skins/sam/colorpicker.css');
	$PAGE->requires->js('/lib/yui/2.9.0/build/colorpicker/colorpicker-min.js');
	$PAGE->requires->css('/mod/checkoutcome/styles.css');
}
else
{
	$PAGE->requires->js('/lib/yuilib/2in3/2.9.0/build/yui2-slider/yui2-slider-min.js');
	$PAGE->requires->js('/lib/yuilib/2in3/2.9.0/build/yui2-utilities/yui2-utilities.js');
	$PAGE->requires->js('/lib/yuilib/2in3/2.9.0/build/assets/skins/sam/colorpicker.css');
	$PAGE->requires->js('/lib/yuilib/2in3/2.9.0/build/yui2-colorpicker/yui2-colorpicker-min.js');
	$PAGE->requires->css('/mod/checkoutcome/styles.css');
}
